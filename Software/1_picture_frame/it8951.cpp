...
//Panel active area 9.7"
#define IT8951_PANEL_WIDTH   1200//1024 //it Get Device information
#define IT8951_PANEL_HEIGHT   825//758
...
uint8_t IT8951_Init()
{
  ...
  //bcm2835_delay(100);
  delay(300); //NOTE 100ms like in specs is not enough
